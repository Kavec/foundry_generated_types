...
declare class ClientDatabaseBackend extends ClientDatabaseBackend_base {
     ...
     * @param {User} user
     */
    static "__#56@#preCreateDocumentArray"(documentClass: typeof Document, request: SocketRequest, user: User): Promise<Document[]>;
    /**
     ...
     */
    static "__#56@#postCreateDocumentCallbacks"(collection: DocumentCollection, result: object[], parent: ClientDocument, pack: string, options: object, userId: string): Array<() => Document>;
    /**
     ...
     * @param {User} user
     */
    static "__#56@#preUpdateDocumentArray"(collection: DocumentCollection, request: SocketRequest, user: User): Promise<any[]>;
    /**
     ...
     */
    static "__#56@#postUpdateDocumentCallbacks"(collection: DocumentCollection, result: object[], options: object, userId: string): Array<() => Document>;
    /**
     ...
     * @param {User} user
     */
    static "__#56@#preDeleteDocumentArray"(collection: DocumentCollection, ids: string[], options: object, user: User): Promise<string[]>;
    /**
     ...
     */
    static "__#56@#postDeleteDocumentCallbacks"(collection: DocumentCollection, ids: string[], options: object, userId: string): Array<() => Document>;
    /**
     ...
     */
    static "__#56@#getParent"(uuid: string | null, options?: object): Promise<ClientDocument>;
    /**
     ...
     */
    static "__#56@#getCollection"(documentName: string, parent: ClientDocument | null, pack: string): DocumentCollection | CompendiumCollection;
    /**
     * Build a CRUD request.
     * @param {SocketRequest} request  The initial request data.
     * @returns {SocketRequest}
     */
    static "__#56@#buildRequest"({ documentClass, action, data, updates, ids, options, pack, parent }: SocketRequest): SocketRequest;
    /**
     ...
     */
    static "__#56@#buildResponse"({ action, documents, options }: {
        action: string;
     ...
     */
    static "__#56@#getTokenAncestor"(parent: ClientDocument): TokenDocument | null;
    /** @inheritdoc */
