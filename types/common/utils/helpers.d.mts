 ...
 * @ignore
 */
export function rgbToHsv(r: any, g: any, b: any): [number, number, number];
/**
 * @deprecated since v10
 * @ignore
 */
export function hsvToRgb(h: any, s: any, v: any): [number, number, number];
/**
 * @deprecated since v10
 * @ignore
 */
export function rgbToHex(rgb: any): Color;
/**
 * @deprecated since v10
 * @ignore
 */
export function hexToRGB(hex: any): [number, number, number];
/**
 * @deprecated since v10
 * @ignore
 */
export function hexToRGBAString(hex: any, alpha?: number): string;
/**
 * @deprecated since v10
 * @ignore
 */
export function colorStringToHex(color: any): number | Color;
/**
