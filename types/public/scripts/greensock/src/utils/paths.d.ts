...
export function getPositionOnPath(rawPath: any, progress: any, includeAngle: any, point: any): any;
...
export function flatPointsToSegment(points: any, curviness?: number): any[];
export function pointsToSegment(points: any, curviness: any): number[];
