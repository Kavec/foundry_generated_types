...
declare class DocumentSheetConfig extends FormApplication {
     ...
     *                                                      users.
     */
    static "__#13@#registerSheet"({ documentClass, id, label, sheetClass, types, makeDefault, canBeDefault, canConfigure }?: {
     ...
     */
    static "__#13@#unregisterSheet"({ documentClass, id, types }?: {
        documentClass: typeof ClientDocument;
        id: string;
        types: object[];
    }): void;
